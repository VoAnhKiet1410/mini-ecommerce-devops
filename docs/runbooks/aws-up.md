...
- Placeholders replaced: `YOUR_ORG`, `YOUR_AWS_ACCOUNT_ID`, `your-aws-profile`
...
helm upgrade --install aws-load-balancer-controller eks/aws-load-balancer-controller \
  ...
  --set serviceAccount.annotations."eks\.amazonaws\.com/role-arn"=arn:aws:iam::YOUR_AWS_ACCOUNT_ID:role/mini-ecommerce-devops-alb-controller
```
...
helm upgrade --install external-secrets external-secrets/external-secrets \
  ...
  --set serviceAccount.annotations."eks\.amazonaws\.com/role-arn"=arn:aws:iam::YOUR_AWS_ACCOUNT_ID:role/mini-ecommerce-devops-external-secrets
```
